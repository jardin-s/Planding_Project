						...
						<thead>
							...
							<tr class="text-start">
								<th class="py-2">
									...
									<div class="progress col-10 mt-2" role="progressbar" aria-label="Basic example" aria-valuenow="75.5" aria-valuemin="0" aria-valuemax="100" style="height:20px">
										<div class="progress-bar" style="width: 75.5%">75.5%</div>
									</div>
								</th>					
							</tr>
							<tr class="text-start">
									...
									<td class="pt-3">
										<div class="row">
											...
											<select class="form-select form-select-lg mb-3">
												<option selected>1000원 (최소후원금)</option>
											</select>
											</div>
											<div class="col-4">
												...
												<button type="button" class="btn btn-primary py-2 px-4 d-none d-md-block d-xl-none"><i class="fas fa-donate"></i></button>
											</div>
										</div>
