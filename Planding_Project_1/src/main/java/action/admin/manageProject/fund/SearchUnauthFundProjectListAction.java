...
public class SearchUnauthFundProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = unauthFundProjectListService.getSearchUnauthFundCount(title);
		System.out.println("[SearchUnauthFundProjectListAction] project_tbl 총 검색 미승인 기부 프로젝트 수 = "+listCount);
		
		//검색기준에 따른 기부 프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = unauthFundProjectListService.getSearchUnauthFundList(page, limit, title);
