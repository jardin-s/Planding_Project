...
public class SearchAuthDonateProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		AuthDonateProjectListService authDonateProjectListService = new AuthDonateProjectListService();
		...
		int listCount = authDonateProjectListService.getSearchAuthDonateCount(title);
		System.out.println("[SearchAuthDonateProjectListAction] project_tbl 총 검색 승인 기부 프로젝트 수 = "+listCount);
		
		//검색기준에 따른 기부 프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = authDonateProjectListService.getSearchAuthDonateList(page, limit, title);
		...
		request.setAttribute("showAdmin", "admin/manageProject/donateList/searchOrderAuthDonateProjectList.jsp");
