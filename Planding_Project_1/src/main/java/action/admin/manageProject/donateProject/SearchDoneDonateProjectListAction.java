...
public class SearchDoneDonateProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = doneDonateProjectListService.getSearchDoneDonateCount(title);
		...
		request.setAttribute("showAdmin", "admin/manageProject/searchOrderDoneDonateProjectList.jsp");
