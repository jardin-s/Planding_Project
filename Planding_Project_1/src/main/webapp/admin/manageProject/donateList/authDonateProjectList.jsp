	    		...
	    		<div class="row">
					...
					<div class="col-4 col-md-3">
						<div class="d-flex justify-content-start">
							<form action="orderAuthDonateProjectList.mngp" method="post" name="forder">
		    		...
		    		<div class="col auto">
			    		<div class="d-flex justify-content-end">
			    			<form action="searchAuthDonateProjectList.mngp" method="post" name="fsearch">
		    	...
		    	<div class="row">
					<ul class="pagination justify-content-center">
						<li class="page-item">
							...
							<c:if test="${pageInfo.page > 1}">
								<a class="page-link" href="authDonateProjectList.mngp?page=${pageInfo.page -1 }" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
								</a>	
							</c:if>								
						</li>
						...
						<c:forEach var="pNum" begin="${pageInfo.startPage }" end="${pageInfo.endPage}" step="1">
							...
							<c:if test="${pNum ne pageInfo.page }">
								<li class="page-item"><a class="page-link" href="authDonateProjectList.mngp?page=${pNum}">${pNum}</a></li>
							</c:if>
						</c:forEach>
						...
						<li class="page-item">
							...
							<c:if test="${pageInfo.page < pageInfo.maxPage }">
								<a class="page-link" href="authDonateProjectList.mngp?page=${pageInfo.page +1 }" aria-label="Next">
									<span aria-hidden="true">&raquo;</span>
								</a>
							</c:if>							
						</li>
