        ...
        <div class="container text-center pt-5">
            ...
            <div class="row justify-content-center">
	            <ul class="col-12 col-lg-8 nav nav-pills justify-content-center mt-5 mb-0">
					...
					<li class="col-3 nav-item"><a class="nav-link active fw-bold" aria-current="page" href="#">미승인 프로젝트</a></li>
					<li class="col-3 nav-item"><a class="nav-link text-white" href="authDonateProjectList.mngp">승인된 프로젝트</a></li>
					<li class="col-3 nav-item"><a class="nav-link text-white" href="doneDonateProjectList.mngp">종료된 프로젝트</a></li>
	            </ul>
            </div>
        </div>
    </div>
    		...
    		<div class="row">
				...
				<div class="col-4 col-md-3">
					<div class="d-flex justify-content-start">
						<form action="orderUnauthDonateProjectList.mngp" method="post" name="forder">
	    		...
	    		<div class="col auto">
		    		<div class="d-flex justify-content-end">
		    			<form action="searchUnauthDonateProjectList.mngp" method="post" name="fsearch">
