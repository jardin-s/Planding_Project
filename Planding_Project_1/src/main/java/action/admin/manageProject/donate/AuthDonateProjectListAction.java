...
public class AuthDonateProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("[AuthDonateProjectListAction] project_tbl 총 승인 기부프로젝트 수 = "+listCount);
		
		//기부 프로젝트 목록을 얻어옴 (기본값 : 최근 가입순)
		ArrayList<ProjectBean> projectList = authDonateProjectListService.getAuthDonateList(page, limit);
		...
		request.setAttribute("showAdmin", "admin/manageProject/donateList/authDonateProjectList.jsp");
