				...
				<div class="col-md-6 pt-4 px-4">
					<table class="table">
						<thead>
							<tr class="text-start">
								<th class="py-2">
									...
									&nbsp;<span style="font-size:2rem; font-weight:normal">0</span>&nbsp;원
								</th>					
							</tr>
							<tr class="text-start">
								<th class="py-2">
									<span class="fw-normal">&nbsp;달성률</span>
									<div class="progress col-10 mt-2" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height:20px">
						...
						<tbody>
							<tr>
								<td class="py-3">
									<button type="button" class="btn btn-light" style="width:100%" disabled>9일 이후부터 후원가능</button>	
								</td>
							</tr>
