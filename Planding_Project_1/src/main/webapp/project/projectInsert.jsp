		...
		<form action="insert_project.pj" method="post">
			...
			<div class="mb-3">
				<select class="form-select" aria-label="bank"  id="bank" name="bank" onchange="otherBank()" required>
					<option disabled selected>입금계좌 은행</option>
			...
			<div align="center">
			<input class="btn btn-primary" type="submit" value="프로젝트 등록하기"><!-- 유효성 검사는 모든 항목에 required를 입력하여 대체함, 다만 시작일 이후에는 수정할 수 없다는 문구를 넣었으면 함 -->
			</div>
		</form>
