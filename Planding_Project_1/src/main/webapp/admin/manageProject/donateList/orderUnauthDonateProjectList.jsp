        ...
        <div class="container text-center pt-5">
            ...
            <div class="row justify-content-center">
	            <ul class="col-12 col-lg-8 nav nav-pills justify-content-center mt-5 mb-0">
					<li class="col-3 nav-item"><a class="nav-link active fw-bold" aria-current="page" href="#">전체 프로젝트</a></li>
		    	...
		    	<div class="row">
					<ul class="pagination justify-content-center">
						<li class="page-item">
							...
							<c:if test="${pageInfo.page > 1}">
								<a class="page-link" href="orderUnauthDonateProjectList.mngp?page=${pageInfo.page -1 }&selectOrder=${orderKeyword}" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
								</a>	
							</c:if>								
						</li>
						...
						<c:forEach var="pNum" begin="${pageInfo.startPage }" end="${pageInfo.endPage}" step="1">
							...
							<c:if test="${pNum ne pageInfo.page }">
								<li class="page-item"><a class="page-link" href="orderUnauthDonateProjectList.mngp?page=${pNum}&selectOrder=${orderKeyword}">${pNum}</a></li>
							</c:if>
						</c:forEach>
						...
						<li class="page-item">
							...
							<c:if test="${pageInfo.page < pageInfo.maxPage }">
								<a class="page-link" href="orderUnauthDonateProjectList.mngp?page=${pageInfo.page +1 }&selectOrder=${orderKeyword}" aria-label="Next">
									<span aria-hidden="true">&raquo;</span>
								</a>
							</c:if>							
						</li>
