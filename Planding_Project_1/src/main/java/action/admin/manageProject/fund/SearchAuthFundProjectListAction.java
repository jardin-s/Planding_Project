...
public class SearchAuthFundProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = authFundProjectListService.getSearchAuthFundCount(title);
		System.out.println("[SearchAuthFundProjectListAction] project_tbl 총 검색 승인 기부 프로젝트 수 = "+listCount);
		
		//검색기준에 따른 기부 프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = authFundProjectListService.getSearchAuthFundList(page, limit, title);
		...
		request.setAttribute("showAdmin", "admin/manageProject/fundList/searchOrderAuthFundProjectList.jsp");
