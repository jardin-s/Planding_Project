    ...
    <!-- Page Header End -->
    	...
    	<div class="container-xxl py-5">
    		<div class="container col-lg-8 mb-5">
   				<p class="text-center">플래너명의 프로젝트명<br>리워드 관리 페이지</p>
    		</div>
    	</div>
					...
					<table class="table table-hover">
						<thead class="sticky-header">
							<tr class="text-center">
								<th scope="col" class="col-1">r_id</th>
								<th scope="col" class="col-auto">r_name</th>
								<th scope="col" class="col-2">r_content</th>
								<th scope="col" class="col-2">r_price</th>
