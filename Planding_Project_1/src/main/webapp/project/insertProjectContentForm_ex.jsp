...
//만약 세션에 저장된 이미지가 있다면 해당 이미지를 불러오기
String[] contentImgss;
	...
	<div class="m-5">
		<form action="insertProjectTemp.pj" method="post" enctype="multipart/form-data"	>
			...
			<div class="mb-3">
				...
				<!-- image_tbl -->
				<input type="file" class="form-control" id="thumbnail" name="thumbnail" required value="${sessionScope.thumbnail }" accept="image/*"  onchange="validateImageFile(this)">
			</div>
