...
public class UserNoticeListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("[UserNoticeListAction] notice_tbl의 전체 문의글 개수 = "+listCount);
		
		ArrayList<NoticeBean> noticeList = noticeListService.getNoticeList(page, limit);//원하는 페이지넘버의 원하는개수만큼 글을 가져옴
