...
public class SearchDonateProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = manageDonateProjectListService.getSearchDonateCount(title);
		System.out.println("[SearchDonateProjectListAction] project_tbl 총 검색 기부 프로젝트 수 = "+listCount);
		
		//검색기준에 따른 기부 프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = manageDonateProjectListService.getSearchDonateList(page, limit, title);
		...
		request.setAttribute("showAdmin", "admin/manageProject/donateList/searchDonateProjectList.jsp");
