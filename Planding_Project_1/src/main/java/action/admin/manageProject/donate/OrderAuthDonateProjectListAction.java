...
public class OrderAuthDonateProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = authDonateProjectListService.getAuthDonateCount();
		System.out.println("[OrderAuthDonateProjectListAction] project_tbl 총 승인 기부프로젝트 수 = "+listCount);
		
		//정렬기준에 따른 기부프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = authDonateProjectListService.getOrderAuthDonateList(order, page, limit);
