        ...
        <div class="container text-center pt-5">
            ...
            <div class="row justify-content-center">
	            <ul class="col-12 col-lg-8 nav nav-pills justify-content-center mt-4 mb-0">
					...
					<li class="col-4 nav-item"><a class="nav-link text-white" href="deletedMemberList.adm" href="#">탈퇴 회원</a></li>
	            </ul>
            </div>
        </div>
    </div>
	    ...
	    <div class="container-fluid pt-4 pb-3">
	    	<div class="container col-lg-8 px-0">
				<div class="row">
	    			...
	    			<form action="searchUndeletedMemberList.adm" method="post" name="fsearch">
		    			<div class="col auto">
