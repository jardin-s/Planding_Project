...
public class OrderFundProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = manageFundProjectListService.getFundCount();
		System.out.println("[OrderFundProjectListAction] project_tbl 총 기부프로젝트 수 = "+listCount);
		
		//정렬기준에 따른 기부프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = manageFundProjectListService.getOrderFundList(order, page, limit);
