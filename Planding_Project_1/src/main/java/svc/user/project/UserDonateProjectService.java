...
public class UserDonateProjectService {
	...
	public boolean donateProjectNotAddr(DonationBean donation) {
		...
		int updateProjectAmountCount = projectDAO.updateProjectCurrAmountPlus(donation.getProject_id(), donation.getTotalDonation_Cal());
	...
	public int getUserMoney(String member_id) {
		...
		/*-------DAO의 해당 메서드를 호출하여 처리----------------------------------------------------*/
		int userMoney = userDAO.selectUserMoney(member_id);
