...
public class OrderUnauthDonateProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("[OrderUnauthDonateProjectListAction] project_tbl 총 미승인 기부프로젝트 수 = "+listCount);
		
		//정렬기준에 따른 기부프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = unauthDonateProjectListService.getOrderUnauthDonateList(order, page, limit);
		...
		request.setAttribute("showAdmin", "admin/manageProject/donateList/searchOrderUnauthDonateProjectList.jsp");
