						...
						<thead>
							<tr class="text-start">
								<th class="py-2">
									...
									&nbsp;<span style="font-size:2rem; font-weight:normal">285,000</span>&nbsp;원
								</th>					
							</tr>
							<tr class="text-start">
								<th class="py-2">
									<span class="fw-normal">&nbsp;달성률</span>
									<div class="progress col-10 mt-2" role="progressbar" aria-label="Basic example" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100" style="height:20px">
							...
							<tr class="text-start">
								<th class="py-3">
									...
									&nbsp;후원 기간 <span class="fw-normal ms-2">2023.9.7 ~ 2023.9.17</span>
								</th>					
							</tr>
						</thead>
						<tbody>
