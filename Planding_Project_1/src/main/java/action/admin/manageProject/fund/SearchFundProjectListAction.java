...
public class SearchFundProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ManageFundProjectListService manageFundProjectListService = new ManageFundProjectListService();
		...
		int listCount = manageFundProjectListService.getSearchFundCount(title);
		System.out.println("[SearchFundProjectListAction] project_tbl 총 검색 기부 프로젝트 수 = "+listCount);
		
		//검색기준에 따른 기부 프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = manageFundProjectListService.getSearchFundList(page, limit, title);
		...
		request.setAttribute("showAdmin", "admin/manageProject/fundList/searchOrderFundProjectList.jsp");
