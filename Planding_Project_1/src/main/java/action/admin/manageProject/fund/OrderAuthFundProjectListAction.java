...
public class OrderAuthFundProjectListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("[OrderAuthFundProjectListAction] project_tbl 총 승인 기부프로젝트 수 = "+listCount);
		
		//정렬기준에 따른 기부프로젝트 목록을 얻어옴
		ArrayList<ProjectBean> projectList = authFundProjectListService.getOrderAuthFundList(order, page, limit);
